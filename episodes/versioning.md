...
<figure style="text-align: center;">
    <figcaption><em>Examples of major, minor and patch releases of Python.</em>.</figcaption>
</figure>
...
```bash
$ git commit -m "feat(add_estimator): add estimator function for linear regression"
